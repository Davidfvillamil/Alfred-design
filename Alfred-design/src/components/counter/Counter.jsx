        ...
        <div className="container text-center">
            <div className="row g-4">
                <div className="col-lg-3 col-sm-6">
                    <h1 className='text-white display-4'>900+</h1>
                    <h6 className='text-uppercase mb-0 text-white mt-3'>Videos edited</h6>
                </div>
                <div className="col-lg-3 col-sm-6">
                    <h1 className='text-white display-4'>50+</h1>
                ...
                <div className="col-lg-3 col-sm-6">
                    <h1 className='text-white display-4'>500+</h1>
                    <h6 className='text-uppercase mb-0 text-white mt-3'>Hours saved to our clients</h6>
                </div>
            </div>
        </div>
    </section>
